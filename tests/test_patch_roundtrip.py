...
result is byte-for-byte the expected v166 patched ISO (by MD5). Also confirms
...
RELEASE_PATCH = os.path.join(WIZ, "release", "busin0_en_v166.xdelta")
SITE_PATCH = r"C:\Programmieren\WizardryTranslationSite\public\patch\busin0_en_v166.xdelta"

SOURCE_MD5 = "48a5639afdf9931913c7dde298dc5349"   # JP SLPM-65378 v2.01
PATCHED_MD5 = "76a75374b0e6f2e7b8e767a1d545b408"  # v166 patched ISO
