...
result is byte-for-byte the expected v202 patched ISO (by MD5). Also confirms
...
RELEASE_PATCH = os.path.join(WIZ, "release", "busin0_en_v202.xdelta")
SITE_PATCH = r"C:\Programmieren\WizardryTranslationSite\public\patch\busin0_en_v202.xdelta"

SOURCE_MD5 = "48a5639afdf9931913c7dde298dc5349"   # JP SLPM-65378, software v1.03
PATCHED_MD5 = "95dea66003b6d0ed6d333010fdeb73ea"  # v202 patched ISO
