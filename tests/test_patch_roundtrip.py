...
result is byte-for-byte the expected v185 patched ISO (by MD5). Also confirms
...
RELEASE_PATCH = os.path.join(WIZ, "release", "busin0_en_v185.xdelta")
SITE_PATCH = r"C:\Programmieren\WizardryTranslationSite\public\patch\busin0_en_v185.xdelta"

SOURCE_MD5 = "48a5639afdf9931913c7dde298dc5349"   # JP SLPM-65378, software v1.03
PATCHED_MD5 = "6383c932452d4df95c7dd96c6551c65c"  # v185 patched ISO
