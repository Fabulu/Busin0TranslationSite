...
CLI:
```
xdelta3 -d -s "Busin 0 - Wizardry Alternative Neo (Japan) (v2.01).iso" busin0_en_v181.xdelta BUSIN0_EN.iso
```
GUI ([Delta Patcher](https://github.com/marco-calautti/DeltaPatcher)): Original file = your JP ISO, Patch = `busin0_en_v181.xdelta`, then Apply.

**Verify your patched output** (optional but recommended) — the resulting ISO MD5 should be:
`e890be7f0d69b388815aaa45d3fb619a`. If it matches, the patch applied perfectly.
