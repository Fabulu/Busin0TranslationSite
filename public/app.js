...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "feat.hardware.body": "The patch modifies the real disc data itself, the fonts, scripts and menus, so it works on hardware rather than as an emulator overlay.",
      ...
      "cap.chargen_race": "Choosing a race in character creation.",
      ...
      "dl.apply_gui": "Or use a GUI such as <a href=\"https://github.com/marco-calautti/DeltaPatcher\" target=\"_blank\" rel=\"noopener\">Delta Patcher</a>: set the original file to your JP ISO, the patch to busin0_en_v201.xdelta, then Apply.",
      ...
      "cl.v202.date": "August 2026",
      "cl.v202.sub": "The new-game bonus for owning the previous game now works with its US release, Wizardry: Tale of the Forsaken Land.",
      "cl.v202.i1": "Starting a new game while a save from the previous title sits on your memory card gives you a small head start: extra points at character creation, slightly better starting gear, and pre-made companions renamed after that game's cast. Until now, Busin 0 only looked for a save from the Japanese original. It now looks for the North American release instead, Wizardry: Tale of the Forsaken Land (Atlus, 2001, disc serial SLUS-20259), which is the version an English-patch player is far more likely to own. Just keep a save from that US game on a memory card in your console and boot Busin 0; booting the US game once and saving is enough. Confirmed working on a real save.",
      "cl.v202.i2": "A quick note if you own the Japanese original: the check was switched over to the US game rather than added on top of it, so a save from the Japanese BUSIN ~Wizardry Alternative~ (SLPM-62098) no longer counts. This is the first change to the game's executable since v180, and it is just a single memory-card directory name, so stability is unchanged. This disc is SLPM-65378, software v1.03.",
      "cl.v201.date": "July 2026",
      "cl.v201.sub": "A few overheard shouts now use plain English quotes instead of Japanese-style corner brackets.",
      "cl.v201.i1": "Eleven short overheard lines (things like “Oww!”, “Hey!”, “Wait!”) were displaying with Japanese corner-quote brackets 『 』 around them - faithful to the original, but out of place in an English script. They now use ordinary quotation marks, matching the game's other shouted lines. This one we could actually prove without a screenshot: the game's own text data plus a matching save-state confirmed exactly which quote marks those brackets draw on screen. Game code is byte-identical to v200 outside these 11 text lines. This disc is SLPM-65378, software v1.03.",
      "cl.v200.date": "July 2026",
      "cl.v200.sub": "One consistent name for the Identification Bracelet, and a few placeholder spots now show their real values.",
      "cl.v200.i1": "The Identification Bracelet has one name everywhere now. This item was written six different ways across the script (Identification / Identify / Appraisal / ID Bracelet) - and one lottery scene even announced an “Appraisal Bracelet,” then handed you an “Id Bracelet” two lines later. It now reads “Id Bracelet” everywhere, matching your inventory menu.",
      "cl.v200.i2": "A few placeholder spots now show their real values. In the Salem quest, a line about the revival cost showed a literal “[g]” instead of the gold amount, and the resurrection narration plus one Automata line showed “[name]” / “[class]” where the game means to insert your leader's name or class. These now use the game's proper insertion tokens, so the actual value should display. As with the earlier number fixes, we verified this against the game's data but couldn't boot-test the exact scenes - please report if any of these still shows a code instead of a value.",
      "cl.v200.i3": "Plus small text fixes: a district spelling “Valley”→“Vallee” so a memo matches the place it points to, “Can not”→“Cannot,” and one item renamed “Old Magestone” so it's distinct from the generic magic stones. Game code is byte-identical to v199 outside these text lines. This disc is SLPM-65378, software v1.03.",
      "cl.v199.date": "July 2026",
      "cl.v199.sub": "A proofreading pass: a few name and text fixes from a read-through of the script.",
      "cl.v199.i1": "A handful of small text corrections from a proofreading sweep of the whole script (which came back very clean overall). Two lines called a character “Vail” and one called another “Uri” - corrected to their canonical names Weil and Uli. A nameplate that had rendered as garbled text now reads “Fouquet.” And one line that showed a stray “[Yes] [No]” that was never part of the dialogue is cleaned up. Game code is byte-identical to v198 outside these text lines. This disc is SLPM-65378, software v1.03.",
      "cl.v198.date": "July 2026",
      "cl.v198.sub": "A quick follow-up to v197: your member number now shows on every district's member card.",
      "cl.v198.i1": "Consistency follow-up to v197. Ten member-card lines in the remaining Automata districts were still missing their member-number insert - they never showed the “0123456789” leak, but they also weren't printing the number. They now display your member number like the rest, and a small stray character on one of them is gone. The same in-game-render caveat as v197 applies (please report any number that still looks wrong). Game code is byte-identical to v197 outside these text lines. This disc is SLPM-65378, software v1.03.",
      "cl.v197.date": "July 2026",
      "cl.v197.sub": "The “0123456789” placeholder that leaked into the Salem quest is fixed - and the numbers it stood in for now display.",
      "cl.v197.i1": "The “0123456789” leak is fixed, and the numbers it hid now appear. Several Salem-quest screens (the donation, member cards, the Automata's experience lines, reward gold) showed a raw “0123456789-” string, or a bare “G” with no amount. That string is actually the game's own number-substitution template - a hidden digit table the engine reads to print a runtime number (the gold you owe, your member ID, and so on) - that our text pipeline was accidentally drawing on screen instead of consuming. We stopped it from displaying and restored the number inserts, so the donation now shows the amount owed, member cards show your number, and reward gold prints its value. Thanks to ferrary-neto for the reports and the save files.",
      "cl.v197.i2": "A note on testing. This fix reaches into how the game formats numbers, so we verified it three ways: the disassembled formatter routine, an independent re-check of the patched data, and the actual values sitting in ferrary-neto's save memory (the donation gold really is stored there). The one thing we can't confirm without playing to those exact scenes is the final on-screen pixels - so if a number still looks wrong in the Salem quest or on a member card, please report it. Game code is otherwise byte-identical to v189–v196 outside this number-formatting fix. This disc is SLPM-65378, software v1.03.",
      "cl.v196.date": "July 2026",
      "cl.v196.sub": "A mislabeled reward item, the resurrection-ritual choices, and a cryptic shop-order label.",
      "cl.v196.i1": "The Virgo & Casta reward names the right item. Picking the reward at the end of that escort quest offered an “Ogre Armor” that is really the Spirit Sword - the name had been mis-read from the game's own scrambled text. Both the choice menu and the “you got it!” message now say Spirit Sword. (As always, the item you received was correct; only the displayed name was wrong.)",
      "cl.v196.i2": "The resurrection ritual's options make sense now. During the Salem quest, when the priest asks you to place your fallen leader on the bier, the three choices were mislabeled and out of order - and read as though you were lying down yourself. They now correctly read: sit the leader on the bed, lay the leader on the bed, or put the leader beneath it, matching what each choice actually does.",
      "cl.v196.i3": "A cryptic guild-order label is clearer. On Vigger's order board, an order shown as “RcvEq” now reads “Recov” (short for Recovery Equipment; the slot only fits five letters). Still under investigation: the “0123456789” placeholder and the missing gold amount some of you saw in the Salem quest - those are a number-substitution quirk in the game's own text engine, and we're using your save states to trace it. Thanks to ferrary-neto for all three reports and the save files. Game code is byte-identical to v189–v195, so stability is unchanged. This disc is SLPM-65378, software v1.03.",
      "cl.v195.date": "July 2026",
      "cl.v195.sub": "Item names in dialogue now match your menus - a sweep spun out of the Janken “Cursed Armor” report.",
      "cl.v195.i1": "Item names in dialogue now match the menu. That Janken report (the “Cursed Armor” that's really the Broken Sword) led to a whole class: because each part of the game renders text on its own glyph set, some conversations named an item differently than your inventory does. We swept the game and corrected 66 lines so an item reads the same whether you're told about it or holding it - the arena's “Recovery Medicine” (previously Dragon Potion / Stamina Scroll / Recovery Vial / Potion of Recovery), “Silence Breaker,” “Silver Hair Ornament,” “Samurai Soul” (was “Samurai Gem”), “Return Potion” (was “Return Scroll”), Bishop Cloak, Osafune, and more. Every change was checked against the Japanese and the official guide. Thanks to ferrary-neto and Gyoru whose reports surfaced this. Game code is byte-identical to v190–v194, so stability is unchanged. This disc is SLPM-65378, software v1.03.",
      "cl.v194.date": "July 2026",
      "cl.v194.sub": "A quick fix: the Janken quest now names the item you actually need.",
      "cl.v194.i1": "The Janken game asks for the right item now. To play the Janken Man's game you hand over a Broken Sword (the “proof you beat an orc” alchemy item) - but the dialogue was calling it a “Cursed Armor.” All of his lines now correctly say Broken Sword. Thanks to ferrary-neto for catching it. Game code is byte-identical to v190–v193, so stability is unchanged. This disc is SLPM-65378, software v1.03.",
      "cl.v193.date": "July 2026",
      "cl.v193.sub": "Shop and inventory now use the same item names, plus several menu and text fixes from Gyoru's report.",
      "cl.v193.i1": "Shop and inventory use the same item names now. The Seraph self-shop sold “Healing Potion / Antidote / Rest Potion,” but your bag showed different names for the very same items. They're reconciled and shortened: Medicine, Antidote, Tonic (and Return Potion stays as-is). Fixed everywhere those items appear - the shop, your inventory, the girl's stall, and the B1 pouches.",
      "cl.v193.i2": "A batch of menu and text fixes. Unidentified swords now read “? Sword” instead of “? Shuriken.” The message when nobody can identify an item reads “No one able” instead of the garbled “No one heal.” Trap names like “Crossbow Trap” no longer run together. And the Seraph self-shop's menu shows its three options - Buy / Help / Exit - instead of the greeting text bleeding over them.",
      "cl.v193.i3": "Thanks to Gyoru for the sharp, detailed report. Game code is byte-identical to v190–v192, so stability is unchanged. This disc is SLPM-65378, software v1.03.",
      "cl.v192.date": "July 2026",
      "cl.v192.sub": "A wave of wording fixes - mistranslated spell and item names, a Sell/Buy swap, and several dialogue corrections.",
      "cl.v192.i1": "Spell and item names fixed. The warp-home spell now reads “Leap” and the trap-disarm spell “Repeal” - both had been left as the untranslated “Ripu.” The Spleem and Salome stone descriptions now correctly say they hit an enemy group (not a single target). And the whole Kreta Stone quest calls the item a “Stone” instead of a “Sword” - a glyph mix-up that had crept into 17 lines.",
      "cl.v192.i2": "More dialogue corrections. Lang's lake-quest item is now “Medicine” (fitting the doctor) instead of “Barrier”/“Potion.” The Vigger shop storage menu now says “Sell” where it had mistakenly said “Buy.” A B1F item hidden in a stash of barrels no longer says “stairs,” and the wounded-fighter scene now reads “we were ambushed” while crossing the bridge (it had said “you” / “corridor”).",
      "cl.v192.i3": "Huge thanks to SirBewm and ferrary-neto for the detailed reports and screenshots - every one was reproduced and checked against the Japanese. Game code is byte-identical to v191, so stability is unchanged. This disc is SLPM-65378, software v1.03.",
      ...
      "bugs.intro": "This is a public beta, and bug reports are the whole point. Deep and late-game content is largely untested.",
      "bugs.what": "When something breaks, the most useful thing you can send is a save to reproduce from. Please include:",
      "bugs.item_state": "A PCSX2 save state (default hotkey F1) from just before a crash, not from the frozen screen itself.",
      ...
      "bugs.item_version": "The patch version (v201 beta).",
    ...
    de: {
      ...
      "about.intro": "Busin 0 ist ein über 70 Stunden langer Dungeon-Crawler aus der Ego-Perspektive im Stil von Wizardry, der Japan nie verlassen hat. Dieses Projekt bringt ihn ins Englische, indem es die Disc-Daten selbst patcht, sodass er auf echter PS2-Hardware läuft, nicht nur auf Emulatoren.",
      ...
      "feat.hardware.body": "Der Patch verändert die echten Disc-Daten selbst, also Schriften, Skripte und Menüs, und funktioniert daher auf Hardware statt nur als Emulator-Overlay.",
      ...
      "cap.chargen_race": "Wahl des Volkes bei der Charaktererstellung.",
      ...
      "dl.apply_gui": "Oder eine grafische Oberfläche wie <a href=\"https://github.com/marco-calautti/DeltaPatcher\" target=\"_blank\" rel=\"noopener\">Delta Patcher</a> verwenden: Originaldatei = deine JP-ISO, Patch = busin0_en_v201.xdelta, dann Anwenden.",
      ...
      "cl.exp": "bootet nicht",
      "cl.v202.date": "August 2026",
      "cl.v202.sub": "Der Neues-Spiel-Bonus für den Besitz des Vorgängerspiels funktioniert jetzt mit dessen US-Version, Wizardry: Tale of the Forsaken Land.",
      "cl.v202.i1": "Wenn du ein neues Spiel startest und ein Spielstand des Vorgängertitels auf deiner Memory Card liegt, bekommst du einen kleinen Vorsprung: zusätzliche Punkte bei der Charaktererstellung, etwas bessere Startausrüstung und vorgefertigte Gefährten, die nach der Besetzung jenes Spiels benannt sind. Bisher suchte Busin 0 nur nach einem Spielstand des japanischen Originals. Jetzt sucht es stattdessen nach der nordamerikanischen Version, Wizardry: Tale of the Forsaken Land (Atlus, 2001, Disc-Seriennummer SLUS-20259), die ein Spieler mit englischem Patch weitaus eher besitzt. Lege einfach einen Spielstand jenes US-Spiels auf einer Memory Card in deine Konsole und starte Busin 0; das US-Spiel einmal zu starten und zu speichern genügt. Auf einem echten Spielstand bestätigt.",
      "cl.v202.i2": "Ein kurzer Hinweis, falls du das japanische Original besitzt: Die Prüfung wurde auf das US-Spiel umgestellt und nicht zusätzlich hinzugefügt, daher zählt ein Spielstand des japanischen BUSIN ~Wizardry Alternative~ (SLPM-62098) nicht mehr. Dies ist die erste Änderung an der ausführbaren Datei des Spiels seit v180, und es ist nur ein einzelner Memory-Card-Verzeichnisname, die Stabilität bleibt also unverändert. Diese Disc ist SLPM-65378, Software v1.03.",
      "cl.v201.date": "Juli 2026",
      "cl.v201.sub": "Einige mitgehörte Ausrufe verwenden jetzt einfache englische Anführungszeichen statt japanischer Eck-Klammern.",
      "cl.v201.i1": "Elf kurze mitgehörte Zeilen (Dinge wie „Oww!“, „Hey!“, „Wait!“) wurden mit japanischen Eck-Anführungszeichen 『 』 darum herum angezeigt - originalgetreu, aber in einem englischen Skript fehl am Platz. Sie verwenden jetzt gewöhnliche Anführungszeichen, passend zu den anderen gerufenen Zeilen des Spiels. Dies konnten wir tatsächlich ohne Screenshot beweisen: die spieleigenen Textdaten plus ein passender Speicherstand bestätigten genau, welche Anführungszeichen diese Klammern auf dem Bildschirm zeichnen. Der Spielcode ist außerhalb dieser 11 Textzeilen byte-identisch zu v200. Diese Disc ist SLPM-65378, Software v1.03.",
      "cl.v200.date": "Juli 2026",
      "cl.v200.sub": "Ein einheitlicher Name für das Identification Bracelet, und einige Platzhalter-Stellen zeigen jetzt ihre echten Werte.",
      "cl.v200.i1": "Das Identification Bracelet hat jetzt überall einen Namen. Dieser Gegenstand wurde im Skript auf sechs verschiedene Arten geschrieben (Identification / Identify / Appraisal / ID Bracelet) - und eine Lotterie-Szene kündigte sogar ein „Appraisal Bracelet“ an und übergab dann zwei Zeilen später ein „Id Bracelet“. Es heißt jetzt überall „Id Bracelet“, passend zum Inventar-Menü.",
      "cl.v200.i2": "Einige Platzhalter-Stellen zeigen jetzt ihre echten Werte. In der Salem-Quest zeigte eine Zeile über die Wiederbelebungskosten ein wörtliches „[g]“ statt des Goldbetrags, und die Wiederbelebungs-Erzählung sowie eine Automata-Zeile zeigten „[name]“ / „[class]“, wo das Spiel den Namen oder die Klasse deines Anführers einsetzen will. Diese verwenden jetzt die korrekten Einsetzungs-Tokens des Spiels, sodass der tatsächliche Wert angezeigt werden sollte. Wie bei den früheren Zahlen-Fixes haben wir das gegen die Spieldaten verifiziert, konnten die genauen Szenen aber nicht per Boot testen - bitte melden, falls eine davon noch einen Code statt eines Werts zeigt.",
      "cl.v200.i3": "Dazu kleine Textkorrekturen: eine Bezirksschreibweise „Valley“→„Vallee“, damit ein Memo zum Ort passt, auf den es verweist, „Can not“→„Cannot“ und ein Gegenstand umbenannt in „Old Magestone“, damit er sich von den generischen Zaubersteinen unterscheidet. Der Spielcode ist außerhalb dieser Textzeilen byte-identisch zu v199. Diese Disc ist SLPM-65378, Software v1.03.",
      "cl.v199.date": "Juli 2026",
      "cl.v199.sub": "Ein Korrekturdurchgang: einige Namens- und Textkorrekturen aus einem Durchlesen des Skripts.",
      "cl.v199.i1": "Eine Handvoll kleiner Textkorrekturen aus einem Korrekturdurchgang des gesamten Skripts (das insgesamt sehr sauber zurückkam). Zwei Zeilen nannten eine Figur „Vail“ und eine weitere „Uri“ - korrigiert zu ihren kanonischen Namen Weil und Uli. Ein Namensschild, das als verstümmelter Text erschien, liest sich jetzt „Fouquet“. Und eine Zeile, die ein überflüssiges „[Yes] [No]“ zeigte, das nie Teil des Dialogs war, ist bereinigt. Der Spielcode ist außerhalb dieser Textzeilen byte-identisch zu v198. Diese Disc ist SLPM-65378, Software v1.03.",
      "cl.v198.date": "Juli 2026",
      "cl.v198.sub": "Ein schnelles Follow-up zu v197: Deine Mitgliedsnummer wird jetzt auf der Mitgliedskarte jedes Bezirks angezeigt.",
      "cl.v198.i1": "Konsistenz-Follow-up zu v197. Zehn Mitgliedskarten-Zeilen in den übrigen Automata-Bezirken hatten noch keine Mitgliedsnummer-Einsetzung - sie zeigten nie das „0123456789“-Leck, gaben aber auch die Zahl nicht aus. Sie zeigen jetzt deine Mitgliedsnummer wie die anderen, und ein kleines überflüssiges Zeichen auf einer davon ist weg. Es gilt derselbe In-Game-Render-Vorbehalt wie bei v197 (bitte melde jede Zahl, die noch falsch aussieht). Der Spielcode ist außerhalb dieser Textzeilen byte-identisch zu v197. Diese Disc ist SLPM-65378, Software v1.03.",
      "cl.v197.date": "Juli 2026",
      "cl.v197.sub": "Der „0123456789“-Platzhalter, der in die Salem-Quest durchsickerte, ist behoben - und die Zahlen, für die er stand, werden jetzt angezeigt.",
      "cl.v197.i1": "Das „0123456789“-Leck ist behoben, und die Zahlen, die es verbarg, erscheinen jetzt. Mehrere Salem-Quest-Bildschirme (die Spende, Mitgliedskarten, die Erfahrungszeilen der Automata, Belohnungsgold) zeigten einen rohen „0123456789-“-String oder ein bloßes „G“ ohne Betrag. Dieser String ist tatsächlich die spieleigene Zahlen-Einsetzungsvorlage - eine versteckte Zifferntabelle, die die Engine liest, um eine Laufzeitzahl auszugeben (das geschuldete Gold, deine Mitgliedsnummer usw.) - die unsere Text-Pipeline versehentlich auf den Bildschirm zeichnete, statt sie zu verbrauchen. Wir haben verhindert, dass sie angezeigt wird, und die Zahleneinsetzungen wiederhergestellt, sodass die Spende jetzt den geschuldeten Betrag zeigt, Mitgliedskarten deine Nummer anzeigen und Belohnungsgold seinen Wert ausgibt. Danke an ferrary-neto für die Reports und die Speicherdateien.",
      "cl.v197.i2": "Ein Hinweis zum Testen. Dieser Fix greift tief in die Zahlenformatierung des Spiels ein, daher haben wir ihn dreifach verifiziert: die disassemblierte Formatierungsroutine, eine unabhängige Nachprüfung der gepatchten Daten und die tatsächlichen Werte in ferrary-netos Speicherstand (das Spendengold ist dort wirklich gespeichert). Das Einzige, was wir ohne das Durchspielen dieser genauen Szenen nicht bestätigen können, sind die finalen Bildschirm-Pixel - falls also eine Zahl in der Salem-Quest oder auf einer Mitgliedskarte noch falsch aussieht, bitte melden. Der Spielcode ist außerhalb dieses Zahlenformatierungs-Fixes byte-identisch zu v189–v196. Diese Disc ist SLPM-65378, Software v1.03.",
      "cl.v196.date": "Juli 2026",
      "cl.v196.sub": "Ein falsch benannter Belohnungsgegenstand, die Optionen des Wiederbelebungsrituals und ein kryptisches Auftrags-Label.",
      "cl.v196.i1": "Die Virgo-&-Casta-Belohnung nennt den richtigen Gegenstand. Bei der Belohnung am Ende dieser Eskort-Quest wurde eine „Ogre Armor“ angeboten, die eigentlich das Spirit Sword ist - der Name war aus dem verschlüsselten Text des Spiels falsch gelesen worden. Sowohl das Auswahlmenü als auch die „Erhalten!“-Meldung sagen jetzt Spirit Sword. (Wie immer war der erhaltene Gegenstand korrekt; nur der angezeigte Name war falsch.)",
      "cl.v196.i2": "Die Optionen des Wiederbelebungsrituals ergeben jetzt Sinn. Während der Salem-Quest, wenn der Priester dich bittet, deinen gefallenen Anführer auf die Bahre zu legen, waren die drei Auswahlmöglichkeiten falsch beschriftet und in falscher Reihenfolge - und lasen sich, als würdest du dich selbst hinlegen. Sie lauten jetzt korrekt: den Anführer auf das Bett setzen, den Anführer auf das Bett legen oder den Anführer darunter legen, passend zu dem, was jede Wahl tatsächlich bewirkt.",
      "cl.v196.i3": "Ein kryptisches Auftrags-Label ist klarer. Auf Viggers Auftragstafel liest sich ein als „RcvEq“ angezeigter Auftrag jetzt „Recov“ (kurz für Recovery Equipment; der Platz fasst nur fünf Buchstaben). Noch in Untersuchung: der Platzhalter „0123456789“ und der fehlende Goldbetrag, den einige von euch in der Salem-Quest gesehen haben - das ist eine Zahlen-Einsetzungs-Eigenart der spieleigenen Text-Engine, und wir nutzen eure Speicherstände, um sie aufzuspüren. Danke an ferrary-neto für alle drei Reports und die Speicherdateien. Der Spielcode ist byte-identisch zu v189–v195, die Stabilität also unverändert. Diese Disc ist SLPM-65378, Software v1.03.",
      "cl.v195.date": "Juli 2026",
      "cl.v195.sub": "Gegenstandsnamen im Dialog stimmen jetzt mit den Menüs überein - ein Durchlauf aus dem Janken-„Cursed Armor“-Report.",
      "cl.v195.i1": "Gegenstandsnamen im Dialog stimmen jetzt mit dem Menü überein. Der Janken-Report (das „Cursed Armor“, das eigentlich das Broken Sword ist) führte zu einer ganzen Klasse: da jeder Teil des Spiels seinen Text auf einem eigenen Glyphensatz darstellt, benannten einige Gespräche einen Gegenstand anders als das Inventar. Wir haben 66 Zeilen korrigiert, sodass ein Gegenstand gleich heißt, egal ob man davon liest oder ihn hält - das „Recovery Medicine“ der Arena (zuvor Dragon Potion / Stamina Scroll / Recovery Vial / Potion of Recovery), „Silence Breaker“, „Silver Hair Ornament“, „Samurai Soul“ (war „Samurai Gem“), „Return Potion“ (war „Return Scroll“), Bishop Cloak, Osafune und mehr. Jede Änderung wurde gegen das Japanische und den offiziellen Guide geprüft. Danke an ferrary-neto und Gyoru, deren Reports das aufgedeckt haben. Der Spielcode ist byte-identisch zu v190–v194, die Stabilität also unverändert. Diese Disc ist SLPM-65378, Software v1.03.",
      "cl.v194.date": "Juli 2026",
      "cl.v194.sub": "Eine schnelle Korrektur: die Janken-Quest nennt jetzt den Gegenstand, den man wirklich braucht.",
      "cl.v194.i1": "Das Janken-Spiel verlangt jetzt den richtigen Gegenstand. Um das Spiel des Janken-Manns zu spielen, übergibt man ein Broken Sword (den Alchemie-Gegenstand „Beweis, dass du einen Ork besiegt hast“) - aber der Dialog nannte ihn „Cursed Armor“. Alle seine Zeilen sagen jetzt korrekt Broken Sword. Danke an ferrary-neto fürs Entdecken. Der Spielcode ist byte-identisch zu v190–v193, die Stabilität also unverändert. Diese Disc ist SLPM-65378, Software v1.03.",
      "cl.v193.date": "Juli 2026",
      "cl.v193.sub": "Laden und Inventar verwenden jetzt dieselben Gegenstandsnamen, plus mehrere Menü- und Textkorrekturen aus Gyorus Report.",
      "cl.v193.i1": "Laden und Inventar verwenden jetzt dieselben Namen. Der Seraph-Selbstbedienungsladen verkaufte „Healing Potion / Antidote / Rest Potion“, aber dein Beutel zeigte andere Namen für genau dieselben Gegenstände. Sie sind vereinheitlicht und gekürzt: Medicine, Antidote, Tonic (Return Potion bleibt). Überall korrigiert, wo diese Gegenstände erscheinen - im Laden, im Inventar, am Stand des Mädchens und in den B1-Beuteln.",
      "cl.v193.i2": "Eine Reihe von Menü- und Textkorrekturen. Unidentifizierte Schwerter zeigen jetzt „? Sword“ statt „? Shuriken“. Die Meldung, wenn niemand einen Gegenstand identifizieren kann, lautet „No one able“ statt des verstümmelten „No one heal“. Fallennamen wie „Crossbow Trap“ laufen nicht mehr zusammen. Und das Menü des Seraph-Ladens zeigt seine drei Optionen - Buy / Help / Exit - statt dass der Begrüßungstext darüber läuft.",
      "cl.v193.i3": "Danke an Gyoru für den scharfsinnigen, ausführlichen Report. Der Spielcode ist byte-identisch zu v190–v192, die Stabilität also unverändert. Diese Disc ist SLPM-65378, Software v1.03.",
      "cl.v192.date": "Juli 2026",
      "cl.v192.sub": "Eine Welle von Wortlaut-Korrekturen - falsch übersetzte Zauber- und Gegenstandsnamen, ein vertauschtes Verkaufen/Kaufen und mehrere Dialog-Korrekturen.",
      "cl.v192.i1": "Zauber- und Gegenstandsnamen korrigiert. Der Heimkehr-Zauber heißt jetzt „Leap“ und der Fallen-Entschärfungs-Zauber „Repeal“ - beide waren als unübersetztes „Ripu“ stehengeblieben. Die Beschreibungen der Steine Spleem und Salome sagen jetzt korrekt, dass sie eine Gegner-Gruppe treffen (nicht ein einzelnes Ziel). Und die gesamte Kreta-Stein-Quest nennt den Gegenstand jetzt „Stein“ statt „Schwert“ - eine Glyphen-Verwechslung, die sich in 17 Zeilen eingeschlichen hatte.",
      "cl.v192.i2": "Weitere Dialog-Korrekturen. Langs See-Quest-Gegenstand heißt jetzt „Medicine“ (passend zum Arzt) statt „Barrier“/„Potion“. Das Lager-Menü des Vigger-Ladens sagt jetzt „Sell“, wo es fälschlich „Buy“ anzeigte. Ein in einem Fässerlager verstecktes B1F-Item spricht nicht mehr von „Treppen“, und die Szene mit der verwundeten Kämpferin liest sich jetzt „wir wurden überfallen“ beim Überqueren der Brücke (statt „du“ / „Korridor“).",
      "cl.v192.i3": "Riesigen Dank an SirBewm und ferrary-neto für die ausführlichen Reports und Screenshots - jeder wurde reproduziert und gegen das Japanische geprüft. Der Spielcode ist byte-identisch zu v191, die Stabilität also unverändert. Diese Disc ist SLPM-65378, Software v1.03.",
      ...
      "bugs.intro": "Dies ist eine öffentliche Beta, und Fehlerberichte sind der eigentliche Sinn. Tiefe und späte Spielinhalte sind grösstenteils ungetestet.",
      ...
      "bugs.item_state": "Einen PCSX2-Save-State (Standardtaste F1) von kurz vor einem Absturz, nicht erst vom eingefrorenen Bild selbst.",
      ...
      "bugs.item_version": "Die Patch-Version (v201 Beta).",
