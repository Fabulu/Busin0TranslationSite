...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "dl.apply_gui": "Or use a GUI such as <a href=\"https://github.com/marco-calautti/DeltaPatcher\" target=\"_blank\" rel=\"noopener\">Delta Patcher</a>: set the original file to your JP ISO, the patch to busin0_en_v184.xdelta, then Apply.",
      ...
      "bugs.item_version": "The patch version (v184 beta).",
    ...
    de: {
      ...
      "dl.apply_gui": "Oder eine grafische Oberfläche wie <a href=\"https://github.com/marco-calautti/DeltaPatcher\" target=\"_blank\" rel=\"noopener\">Delta Patcher</a> verwenden: Originaldatei = deine JP-ISO, Patch = busin0_en_v184.xdelta, dann Anwenden.",
      ...
      "bugs.item_version": "Die Patch-Version (v184 Beta).",
