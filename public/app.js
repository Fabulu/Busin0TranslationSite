...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "dl.apply_gui": "Or use a GUI such as <a href=\"https://github.com/marco-calautti/DeltaPatcher\" target=\"_blank\" rel=\"noopener\">Delta Patcher</a>: set the original file to your JP ISO, the patch to busin0_en_v173.xdelta, then Apply.",
      ...
      "cl.v173.i1": "Fixed the \u201cempty battle\u201d softlock for real \u2014 some fights showed no monster and/or a stuck camera. The character-creation font data was sitting in battle memory and stalling the monster load; it\u2019s now removed entirely. (Small trade-off: character-creation text spacing is a touch less even.)",
    ...
    de: {
      ...
      "dl.apply_gui": "Oder eine grafische Oberfläche wie <a href=\"https://github.com/marco-calautti/DeltaPatcher\" target=\"_blank\" rel=\"noopener\">Delta Patcher</a> verwenden: Originaldatei = deine JP-ISO, Patch = busin0_en_v173.xdelta, dann Anwenden.",
      ...
      "cl.v173.i1": "Der \u201eleere Kampf\u201c-Softlock ist wirklich behoben \u2014 manche K\u00e4mpfe zeigten kein Monster und/oder eine blockierte Kamera. Die Schriftdaten der Charaktererstellung lagen im Kampfspeicher und blockierten das Laden des Monsters; sie sind jetzt vollst\u00e4ndig entfernt. (Kleiner Kompromiss: Der Textabstand in der Charaktererstellung ist etwas ungleichm\u00e4\u00dfiger.)",
