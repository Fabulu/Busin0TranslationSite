...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "dl.apply_gui": "Or use a GUI such as <a href=\"https://github.com/marco-calautti/DeltaPatcher\" target=\"_blank\" rel=\"noopener\">Delta Patcher</a>: set the original file to your JP ISO, the patch to busin0_en_v171.xdelta, then Apply.",
      ...
      "cl.v171.date": "July 2026",
      "cl.v171.sub": "The bug-fix update: a major battle fix, selectable choices restored, dungeon shops & signs repaired.",
      "cl.v171.i1": "Fixed an \u201cempty battle\u201d softlock \u2014 some fights showed no monster and/or locked the camera. The character-creation font data was sitting in battle memory and corrupting encounters; it\u2019s now moved fully out of the way.",
      "cl.v171.i2": "Choices work again. Events that showed a blank continue-arrow instead of options (the \u201clucky job\u201d game, the resurrection ceremony, Fight/Flee prompts) now let you actually choose.",
      "cl.v171.i3": "The dungeon honesty-box shop no longer softlocks (its exit was one of those broken choices), and the scattered/wrong text on dungeon signs and shop boards is fixed.",
      "cl.v171.i4": "Character-creation stat descriptions corrected (gender, Human, Elf), plus tavern (\u201cNo completed requests\u201d) and camp-menu (Give \u2192 Discard) label fixes.",
      "cl.v171.i5": "Fixed an NPC wrongly nameplated \u201cKnights\u201d.",
      "cl.v171.i6": "Note: the empty-battle fix is a deep engine change. If you still hit a fight with no monster or a stuck camera, please report it \u2014 it helps a lot.",
      ...
      "bugs.item_version": "The patch version (v171 beta).",
    ...
    de: {
      ...
      "dl.apply_gui": "Oder eine grafische Oberfläche wie <a href=\"https://github.com/marco-calautti/DeltaPatcher\" target=\"_blank\" rel=\"noopener\">Delta Patcher</a> verwenden: Originaldatei = deine JP-ISO, Patch = busin0_en_v171.xdelta, dann Anwenden.",
      ...
      "cl.v171.date": "Juli 2026",
      "cl.v171.sub": "Das Fehlerbehebungs-Update: ein grosser Kampf-Fix, ausw\u00e4hlbare Optionen wieder da, Dungeon-L\u00e4den & Schilder repariert.",
      "cl.v171.i1": "Ein \u201eleerer Kampf\u201c-Softlock behoben \u2014 manche K\u00e4mpfe zeigten kein Monster und/oder blockierten die Kamera. Die Schriftdaten der Charaktererstellung lagen im Kampfspeicher und besch\u00e4digten Begegnungen; sie sind jetzt vollst\u00e4ndig aus dem Weg ger\u00e4umt.",
      "cl.v171.i2": "Auswahlm\u00f6glichkeiten funktionieren wieder. Ereignisse, die statt Optionen einen leeren Weiter-Pfeil zeigten (das \u201eGl\u00fccksjob\u201c-Spiel, die Wiederbelebungszeremonie, Kampf/Flucht-Abfragen), lassen dich jetzt wirklich w\u00e4hlen.",
      "cl.v171.i3": "Der Dungeon-Selbstbedienungsladen h\u00e4ngt nicht mehr (sein Ausgang war eine dieser kaputten Auswahlen), und der verstreute/falsche Text auf Dungeon-Schildern und Ladentafeln ist behoben.",
      "cl.v171.i4": "Statuswert-Beschreibungen der Charaktererstellung korrigiert (Geschlecht, Mensch, Elf), dazu Taverne (\u201eKeine erledigten Auftr\u00e4ge\u201c) und Lager-Men\u00fc (Geben \u2192 Wegwerfen).",
      "cl.v171.i5": "Einen NPC korrigiert, der f\u00e4lschlich \u201eKnights\u201c hiess.",
      "cl.v171.i6": "Hinweis: Der Leerer-Kampf-Fix ist ein tiefer Engine-Eingriff. Falls du noch einen Kampf ohne Monster oder mit blockierter Kamera erlebst, melde es bitte \u2014 das hilft sehr.",
      ...
      "bugs.item_version": "Die Patch-Version (v171 Beta).",
