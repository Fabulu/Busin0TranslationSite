...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "cl.v202.sub": "The head-start bonus for owning the previous game now works with its US release — Wizardry: Tale of the Forsaken Land.",
      "cl.v202.i1": "The prequel-save bonus now recognizes the US previous game. Starting a new game with a save from the previous title on your memory card gives a small head start — extra character-creation points, slightly better starting equipment, and pre-made companions renamed after that game's cast. Busin 0 only ever looked for a save from the Japanese predecessor; it now looks for the North American release, Wizardry: Tale of the Forsaken Land (Atlus, 2001 — disc serial SLUS-20259), which is what an English-patch player is far more likely to own. Keep a memory-card save from that US game in your console and boot Busin 0 to receive the bonus — booting the US game once and saving is enough. Boot-confirmed on a real save.",
      "cl.v202.i2": "One note if you have the Japanese predecessor. The check was swapped to the US game, not added alongside it, so a save from the Japanese BUSIN ~Wizardry Alternative~ (SLPM-62098) is no longer detected. This is the first change to the game's executable since v180 — a single memory-card directory name — so stability is unchanged. This disc is SLPM-65378, software v1.03.",
    ...
    de: {
      ...
      "cl.exp": "bootet nicht",
      "cl.v202.date": "August 2026",
      "cl.v202.sub": "Der Vorsprung-Bonus für den Besitz des Vorgängerspiels funktioniert jetzt mit dessen US-Version — Wizardry: Tale of the Forsaken Land.",
      "cl.v202.i1": "Der Bonus für einen Spielstand des Vorgängers erkennt jetzt die US-Version. Wenn du ein neues Spiel startest und ein Spielstand des Vorgängertitels auf deiner Memory Card liegt, erhältst du einen kleinen Vorsprung — zusätzliche Punkte bei der Charaktererstellung, etwas bessere Startausrüstung und vorgefertigte Gefährten, die nach der Besetzung jenes Spiels benannt sind. Busin 0 suchte bisher nur nach einem Spielstand des japanischen Vorgängers; es sucht jetzt nach der nordamerikanischen Version, Wizardry: Tale of the Forsaken Land (Atlus, 2001 — Disc-Seriennummer SLUS-20259), die ein Spieler mit englischem Patch weitaus eher besitzt. Lege einen Memory-Card-Spielstand jenes US-Spiels in deine Konsole und starte Busin 0, um den Bonus zu erhalten — das US-Spiel einmal zu starten und zu speichern genügt. Auf einem echten Spielstand bestätigt.",
      "cl.v202.i2": "Ein Hinweis, falls du den japanischen Vorgänger besitzt. Die Prüfung wurde auf das US-Spiel umgestellt, nicht zusätzlich hinzugefügt, daher wird ein Spielstand des japanischen BUSIN ~Wizardry Alternative~ (SLPM-62098) nicht mehr erkannt. Dies ist die erste Änderung an der ausführbaren Datei des Spiels seit v180 — ein einzelner Memory-Card-Verzeichnisname — die Stabilität bleibt also unverändert. Diese Disc ist SLPM-65378, Software v1.03.",
